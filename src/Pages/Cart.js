...
const Cart = () => {
    ...
    const fetchCart = async () => {
        try {
            const response = await axios.get('http://arocseback.cluster-ig3.igpolytech.fr/api/cart', { withCredentials: true });
    ...
    const removeFromCart = async (productId) => {
        try {
            await axios.post(
                'http://arocseback.cluster-ig3.igpolytech.fr/api/cart/remove',
                { productId },
